export function HeartFilledIcon() {
  return (
    <svg
      ...
      height="27"
      viewBox="0 0 24 24"
      style={{ animation: "st-cellpop 0.3s ease-out both" }}
    >
      <path
...
export function HintIcon() {
  return (
    ...
    >
      ...
      <path d="M12 2a7 7 0 0 0-4 12.7c.6.5 1 1.3 1 2.1V17h6v-.2c0-.8.4-1.6 1-2.1A7 7 0 0 0 12 2z"></path>
    </svg>
  );
}
